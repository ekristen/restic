...
.. code-block:: console
    ...
    AWS_ASSUME_ROLE_ARN                 Amazon IAM Role ARN to assume using discovered credentials
    AWS_ASSUME_ROLE_SESSION_NAME        Session Name to use with the role assumption
    AWS_ASSUME_ROLE_EXTERNAL_ID         External ID to use with the role assumption
    AWS_ASSUME_ROLE_REGION              Region to use for IAM calls for the role assumption
